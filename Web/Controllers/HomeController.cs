...
public class HomeController : Controller
{
    ...
    public IActionResult Error() =>
        View(new ErrorViewModel(500, "Something went wrong", "We could not complete that request. Please try again."));

    public IActionResult StatusCodePage(int code)
    {
        var model = code switch
        {
            401 => new ErrorViewModel(code, "Sign in required", "Please sign in to continue."),
            403 => new ErrorViewModel(code, "Access denied", "You do not have permission to view this page."),
            404 => new ErrorViewModel(code, "Page not found", "That page or resource is not available."),
            _ => new ErrorViewModel(code, "Request could not be completed", "Please check the address and try again.")
        };
